...
export async function updateDefaultTerminalProfile(
	...
	request: proto.nagentcoderai.StringRequest,
): Promise<proto.nagentcoderai.TerminalProfileUpdateResponse> {
	...
	return proto.nagentcoderai.TerminalProfileUpdateResponse.create({
		closedCount,
