...
export async function refreshExternalRulesToggles(
	...
	windsurfLocalToggles: NAgentRulesToggles
	cursorLocalToggles: NAgentRulesToggles
}> {
	// local windsurf toggles
	const localWindsurfRulesToggles = ((await getWorkspaceState(context, "localWindsurfRulesToggles")) as NAgentRulesToggles) || {}
	...
	const localCursorRulesToggles = ((await getWorkspaceState(context, "localCursorRulesToggles")) as NAgentRulesToggles) || {}
 ...
 */
export const getLocalWindsurfRules = async (cwd: string, toggles: NAgentRulesToggles) => {
 ...
 */
export const getLocalCursorRules = async (cwd: string, toggles: NAgentRulesToggles) => {
