import { nAgentCoderAIMessage } from "./ExtensionMessage"

/**
 * Combines sequences of command and command_output messages in an array of nAgentCoderAIMessages.
 *
 * This function processes an array of nAgentCoderAIMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of nAgentCoderAIMessage objects to process.
 * @returns A new array of nAgentCoderAIMessage objects with command sequences combined.
 *
 * @example
 * const messages: nAgentCoderAIMessage[] = [
 ...
 */
export function combineCommandSequences(messages: nAgentCoderAIMessage[]): nAgentCoderAIMessage[] {
	const combinedCommands: nAgentCoderAIMessage[] = []
