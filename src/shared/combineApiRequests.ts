...
/**
 * Combines API request start and finish messages in an array of nAgentCoderAIMessages.
 *
 ...
 * @returns A new array of nAgentCoderAIMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: nAgentCoderAIMessage[]): nAgentCoderAIMessage[] {
	const combinedApiRequests: nAgentCoderAIMessage[] = []
