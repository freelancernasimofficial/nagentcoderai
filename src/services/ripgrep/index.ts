...
export async function regexSearchFiles(
	...
	// Filter results using nAgentCoderAIIgnoreController if provided
	const filteredResults = nagentcoderaiIgnoreController
		? results.filter((result) => nagentcoderaiIgnoreController.validateAccess(result.filePath))
		: results
